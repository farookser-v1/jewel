...
const array = ['Pikachu','Msd','DRACULA','Bilal','Vijay','FAROOKSER','Rashmika','Bilal chunni','song','Sry','Line','Aarulle','achodaa','KING OF BOT EFITORS','ayin','DRACULA DANGER','Aysheri','YRMEDIA','YR MEDIA','LFA','Black','Bilal sed','LFA HERMIT','LFA KING','Myr','Poda','YR MEDIABLACK','black','CNK BLACK','Ayye','Ayyo','broken','bye','chattho','cute','Da','Eee','Eee2','engane und','Entha','Enthada','Girls','Good morning','Good night','Hi','Hy','ithokke enth','ivan','Kurippe','Kurumb','Love','Mm','naanam','nadakkatte','Ok','paavam','Pattumo','pikachu','Pm','poda','Pova','Save','setth','sho','Shoo','Smile','tag','Udayipp','umma','Vaa','Vannu','yo','ys' ]
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
